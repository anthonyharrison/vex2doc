...
Only use a supported version of Python (this is any version of Python from version 3.9).
...
You should then be able to type `vex2doc --help` on the command line, and it should show the help information. If this does not
